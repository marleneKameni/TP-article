  ...
  - name: Kameni Marlene
    affiliations:
      - name: Agroparistech
        ...
        address: Rue Jean francois breton
        city: Montpellier
        country: France
        postal-code: "34090"
...
keywords: [Diversite, perturbation, nombre d'Hill]
# Bibliography
...
La théorie biogéographie des îles propose que la richesse spécifique résulte d’un équilibre dynamique entre immigration et extinction, cette dernière étant notamment influencée par la taille des habitats [@MacArthur1967].
Dans cette perspective, la diversité d’une forêt peut également dépendre de son histoire et des perturbations qu’elle a subies.
La forêt de BCI, notamment, est une forêt secondaire issue de perturbations passées [@Raby2017].
Sa diversité pourrait ainsi être favorisée par un niveau intermédiaire de perturbation, conformément à l’hypothèse de la perturbation intermédiaire proposée par Connell [@Connell1978].
...
# supprimer les cartouches
theme(legend.position = "none")
```
Profils de diversité de paracou 6 (courbe bleu et BCI (courbe rouge). la figure represente le nombre effectif d'espèce (nombre d'hill) en fonctions du nombre de grandeur.
:::
