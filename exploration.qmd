...
paracou6 %>% 
  ...
  profile_hill(n_simulations = 500) %>% 
  # Figure
  autoplot() +
  # Titre de la légende
  labs(color = "Forêt", linetype = "Forêt")
  # Elle prend les données d’abondance des espèces de Paracou et de   # BCI, calcule leur profil de diversité de Hill, puis compare les   # deux forêts sur un graphique.
```
